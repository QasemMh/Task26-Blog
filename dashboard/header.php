...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item -->
            <li class="nav-item <?php echo setActive("Category"); ?>">
            ...
            <!-- Nav Item -->
            <li class="nav-item <?php echo setActive("Post"); ?>">
                <a class="nav-link" href="post.php">
                    <i class="fas fa-fw fa-user"></i>
                    <span>Posts</span></a>
            </li>
            <!-- Nav Item -->
            <li class="nav-item <?php echo setActive("Post Comment"); ?>">
                <a class="nav-link" href="postComment.php">
                    <i class="fas fa-fw fa-user"></i>
